...
title=tk.Label(root, text="Login Here", font=("Algerian", 30, "bold","italic"),bd=5,bg="#2F4F4F",fg="white")
title.place(x=660,y=150,width=250)
        
Login_frame=tk.Frame(root,bg="#698B69")
Login_frame.place(x=530,y=320)
...
btn_reg=tk.Button(Login_frame,text="Create Account",command=registration,width=15,font=("Times new roman", 14, "bold"),bg="red",fg="white")

...
title.place(x=630,y=20,width=250)
...
btn_log=tk.Button(Login_frame,text="Submit",command=login,width=15,font=("Times new roman", 14, "bold"),bg="Green",fg="black")
